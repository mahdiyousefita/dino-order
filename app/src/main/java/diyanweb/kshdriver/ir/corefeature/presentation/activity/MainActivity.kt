package diyanweb.kshdriver.ir.corefeature.presentation.activity
...
import diyanweb.kshdriver.ir.NavGraphs
import diyanweb.kshdriver.ir.corefeature.domain.model.AppLanguage
import diyanweb.kshdriver.ir.corefeature.domain.model.toLayoutDirection
import diyanweb.kshdriver.ir.corefeature.domain.model.toLocale
import diyanweb.kshdriver.ir.corefeature.presentation.activity.theme.Diyan_Web_AppTheme
import diyanweb.kshdriver.ir.corefeature.presentation.util.HandleUIEvent
import diyanweb.kshdriver.ir.corefeature.presentation.util.LocaleUtils
import diyanweb.kshdriver.ir.corefeature.presentation.viewmodel.MainActivityViewModel
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            HandleUIEvent(app as DiyanWebApplication, navController!!)
